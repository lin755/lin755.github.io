...
<p class="disqus">You can refer to <a href="http://open-estuary.org/getting-started/">http://open-estuary.org/getting-started/</a> to get and build the whole project <code> </code></p>
